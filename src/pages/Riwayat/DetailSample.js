...
export default function DetailSample({ navigation, route }) {
    ...
    const __getTransaksi = () => {
        ...
        POSDataByTable('transaksisample', {
    ...
    return (
        <SafeAreaView style={{
            ...
            <View style={{
                ...
                <MyHeader onPress={() => navigation.goBack()} title="Print Sampel" />
            </View>
            {!loading &&
                <View style={{
                    flex: 1,
