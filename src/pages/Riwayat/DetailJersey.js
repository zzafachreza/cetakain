...
export default function DetailJersey({ navigation, route }) {

    const TheSize = ({ label, value }) => {
        return (
            <View style={{
                flexDirection: 'row'
            }}>
    ...
    const __getTransaksi = () => {
        ...
        POSDataByTable('transaksijersey', {
                ...
                <View style={{
                    ...
                    <View
                        ...
                        <View style={{
                            ...
                            <View>
                                <Image source={{
                                    uri: webURL + item.file_bahanjersey
                                }} style={{
                                    borderRadius: 4,
                                    width: 60,
                                    height: 60,
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <Text style={{
                                    ...
                                    fontSize: 10,
                                    color: Color.blueGray[400]
                                }}>Desain : {item.bahan}</Text>
                                <Text style={{
                                    // flex: 1,
                                    fontFamily: fonts.secondary[400],
                                    fontSize: 10,
                                    color: Color.blueGray[400]
                                }}>Jenis Kain : {item.kain}</Text>
                                <Text style={{
                                    // flex: 1,
                                    fontFamily: fonts.secondary[400],
                                    fontSize: 10,
                                    color: Color.blueGray[400]
                                }}>Jenis Leher : {item.pola}</Text>
                            </View>
                            <View style={{
                                flex: 1,
                            }}>
                                ...
                                <TheSize label="S" value={item.s} />
                                <TheSize label="M" value={item.m} />
                                <TheSize label="L" value={item.l} />
                                <TheSize label="XL" value={item.xl} />
                                <TheSize label="XXL" value={item.xxl} />
                                <TheSize label="XXXL" value={item.xxxl} />
                            </View>
                        </View>
                    </View>
