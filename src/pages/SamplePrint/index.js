...
const dataCorosel = [
  {
    image: require('../../assets/sampleprint1.png'),
    title: 'SAMPEL PRINT',
    description: `Kami menyediakan sampel katalog print kain free,untuk handfeel dan melihat kualitas print kami secara langsung`,


  },

  {
    image: require('../../assets/sampleprint2.png'), // Ganti dengan lokasi gambar Anda
    title: 'SAMPEL PRINT',
    description: `Dan kamu bisa sampel dengan design kamu sendiri ( S&K )`,
...
export default function SamplePrint({ navigation }) {
  ...
  const [selectedFabric, setSelectedFabric] = useState({
    name: 'PRINT SAMPEL', // Default kain
    price: 'FREE',
    image: require('../../assets/sampleprint1.png'), // Default image
  });
  ...
  const fabrics = [
    ...
    {
      name: 'Sampel Print Sendiri',
      price: 'Rp.50.000 (30 CM)',
      image: require('../../assets/sampleprint2.png'), // Ganti dengan path gambar ceruty
    },
  ];
